...
import { getAllCachedImages } from '@/lib/imageCache';
...
export function PortfolioPDFWithCachedImages() {
  return (
    <Document>
      {/* Cover Page */}
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={{ flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-between' }}>
          {products.map((product: any) => {
            ...
            const cachedImageUrl = imageUrl ? cachedImages.get(imageUrl) : null;
            
            return (
              <View key={product.slug} style={styles.productCard}>
                {cachedImageUrl ? (
                  <Image src={cachedImageUrl} style={styles.productImage} />
                ) : imageUrl ? (
          ...
          {clients.map((client: any) => {
            ...
            return (
              <View key={client.title} style={styles.clientCard}>
                {cachedImageUrl ? (
                  <Image src={cachedImageUrl} style={styles.clientLogo} />
                ) : imageUrl ? (
